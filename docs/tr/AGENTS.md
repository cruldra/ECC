...
Bu, yazılım geliştirme için 68 özel agent, 294 skill, 93 command ve otomatik hook iş akışları sağlayan **üretime hazır bir AI kodlama eklentisidir**.
...
skills/          — 294 iş akışı skillleri ve alan bilgisi
commands/        — 93 slash command
